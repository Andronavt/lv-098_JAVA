...
@NamedQueries({
        ...
        @NamedQuery(name = IpAddress.FIND_LOCATION_WHITE_OR_BLACK_LIST, query = IpAddress.FIND_LOCATION_WHITE_OR_BLACK_LIST_QUERY),
...
public class IpAddress {
    ...
    public static final String FIND_LOCATION_WHITE_OR_BLACK_LIST = "IpAddress.findLocationWhiteList";
    public static final String FIND_LOCATION_WHITE_OR_BLACK_LIST_QUERY = "SELECT distinct(ip.location) from IpAddress ip where ip.whiteList = ?1";
    ...
    public static final String FIND_WHITE_OR_BLACK_LIST_BY_CITY_QUERY = "SELECT ip from IpAddress ip where ip.whiteList = ?1 and ip.location.cityName = ?2";
    public static final String FIND_WHITE_OR_BLACK_LIST_BY_COUNTRY = "IpAddress.findWhiteOrBlackListByCountry";

    public static final String FIND_WHITE_OR_BLACK_LIST_BY_COUNTRY_QUERY = "SELECT ip from IpAddress ip where ip.whiteList = ?1 and ip.location.countryName = ?2";
