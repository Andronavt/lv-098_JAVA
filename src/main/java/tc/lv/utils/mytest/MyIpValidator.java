...
public class MyIpValidator implements MyIpValidatorInterface {

	static final String IPV4 = "^((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?){1}\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?){1}\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?){1}\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?){1}){1}";
	static final String IPV6 = "([a-f0-9]{1,4}:([a-f0-9]{1,4}:){1,6}[a-f0-9]{1,4})";
