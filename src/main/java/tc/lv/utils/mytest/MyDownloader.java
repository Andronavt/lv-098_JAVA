...
public class MyDownloader implements MyDownloaderInterface {
	private static final Logger LOGGER = Logger.getLogger(MyDownloader.class);
	...
	public File downloadFile(String urlString, String dir)
		...
		if (urlString.contains(".gz")) {
			return downloadGZ(urlString, dir);

		} else {

			downloadTxT(urlString, dir);
		}
	...
	private void downloadTxT(String urlString, String dir)
			throws DownloadException {
		try {
	...
	private File downloadGZ(String urlString, String dir)
			throws DownloadException {
		try {
