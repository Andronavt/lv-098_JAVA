...
public interface SourceService {
    ...
    public List<IpV4Address> getIpV4ListFromSource(int sourceId) throws DBPersistanceException, DBIllegalArgumentException, DBIllegalStateException, DBException;
      ...
      public void addNewFeed(String parser, String sourceName, String url,  String listType, 
		Double rank) throws DBCreateSourceException, DBPersistanceException, DBIllegalArgumentException, DBIllegalStateException, DBException;
