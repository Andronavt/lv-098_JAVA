...
public class IpAddressServiceImpl implements IpAddressService {
    ...
    public IpAddressServiceImpl() throws IpAddressServiceException {
        try {
            ...
            LOGGER.error(e);
            throw new IpAddressServiceException("Could not initialize GeoIpUtil", e);
        }
    }
    ...
    public boolean saveIpByStatus(String address, String status) throws IpAddressServiceException {
        try {
            ...
            procesingIpAddress(tempIp, ipAddressSaveDetailsService.getSourceByStatus(status));
    ...
    public void saveList(List<? extends IpAddress> list, int sourceId, Class<? extends IpAddress> ipType,
            Map<String, IpAddress> map) throws IpAddressServiceException {
        try {
    ...
    private void ipCountry(IpAddress ip) throws GeoIpException, IpAddressServiceException {
    ...
    private City getLocation(IpAddress ip) throws GeoIpException, IpAddressServiceException {
        if (geoIpUtil == null)
    ...
    @Override
    @Transactional
    public void updateStatusList(Map<String, IpAddress> map) throws IpAddressServiceException {
        ...
        try {
            ...
            LOGGER.error(e);
            throw new IpAddressServiceException("class of Parser cannot be instantiated!", e);
        }
    ...
    @Override
    @Transactional
    public void procesingIpAddress(IpAddress ip, Source source) throws GeoIpException, IpAddressServiceException {
    ...
    private boolean tryToSaveIp(IpAddress ip, Source source) throws GeoIpException, IpAddressServiceException {
    ...
    private boolean tryToUpdateIp(IpAddress ip, Source source) throws IpAddressServiceException {
