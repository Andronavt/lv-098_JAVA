...
public class WhiteListServiceImpl implements WhiteListService {
	...
	@Transactional
	@Override
	public boolean deleteIpV4ByName(String address)
			throws WhiteListServiceException {
		try {
			IpV4Address tempIpV4 = ipAddressDao.findByAddress(address,
					IpQueryEnum.IP_V4);
			...
			throw new WhiteListServiceException(
					"Could not delete IPv4 from White List", e);
		}
	}

	@Transactional
	@Override
	public boolean deleteIpV6ByName(String address)
			throws WhiteListServiceException {
		try {
			...
			LOGGER.error(e);
			throw new WhiteListServiceException(
					"Could not delete IPv6 from White List", e);
		}
	}

	@Transactional
	@Override
	public boolean saveIpV4ByName(String address)
			throws WhiteListServiceException {
		...
		try {
			...
			if ((tempIpV4 == null) || (tempIpV4.getWhiteList() != true)) {
				...
				if (tempIpV4 == null) {
					...
					tempIpV4.getSourceSet().add(
							sourceDao.findByName(ADMIN_WHITE_LIST));
			...
			LOGGER.error(e);
			throw new WhiteListServiceException(
					"Could not save IPv4 to White List", e);
		}
	}
	@Transactional
	@Override
	public boolean saveIpV6ByName(String address)
			throws WhiteListServiceException {
		try {
			IpV6Address tempIpV6 = ipAddressDao.findByAddress(address,
					IpQueryEnum.IP_V6);
			...
			LOGGER.error(e);
			throw new WhiteListServiceException(
					"Could not save IPv6 to White List", e);
		}
	}
	...
	public Collection<IpV4Address> loadIpV4List()
			throws WhiteListServiceException {
		try {
			return (Collection<IpV4Address>) ipAddressDao
					.findWhiteList(IpQueryEnum.IP_V4);

		} catch (Exception e) {
			LOGGER.error(e);
			throw new WhiteListServiceException(
					"Could not load IPv4 White List", e);
		}
	}
	...
	public Collection<IpV6Address> loadIpV6List()
			throws WhiteListServiceException {
		try {
			return (Collection<IpV6Address>) ipAddressDao
					.findWhiteList(IpQueryEnum.IP_V6);

		} catch (Exception e) {
			LOGGER.error(e);
			throw new WhiteListServiceException(
					"Could not load IPv6 White List", e);
		}
	}
	...
	public Collection<IpV4Address> loadIpV4ListByRange(int from, int count)
			throws WhiteListServiceException {
		try {
			return (Collection<IpV4Address>) ipAddressDao.findWhiteList(from,
					count, IpQueryEnum.IP_V4);

		} catch (Exception e) {
			LOGGER.error(e);
			throw new WhiteListServiceException(
					"Could not load IPv4 White List by range", e);
		}
	}
	...
	public Collection<IpV6Address> loadIpV6ListByRange(int from, int count)
			throws WhiteListServiceException {
		try {
			return (Collection<IpV6Address>) ipAddressDao.findWhiteList(from,
					count, IpQueryEnum.IP_V6);

		} catch (Exception e) {
			LOGGER.error(e);
			throw new WhiteListServiceException(
					"Could not load IPv6 White List by range", e);
		}
	}
