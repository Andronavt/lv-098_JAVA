...
public interface IpAddressService {
    ...
    void updateStatusList(Map<String, IpAddress> map) throws IpAddressServiceException;

    public void createAllMaps();

    void procesingIpAddress(IpAddress ip, Source source) throws GeoIpException, IpAddressServiceException;
