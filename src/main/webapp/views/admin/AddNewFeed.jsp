...
<body>
	...
	<form action="newFeed" id="addNewFeed" method="post" name="input_feed">
			...
			<div><b>Add parser:</b></div>
				 <input id="parser" type="text" name="parserIn" size="30" maxlength="30" />

			<div><b>Add source name:</b></div>
				<input id="sourceName"  type="text" name="sourceNameIn" size="30" maxlength="50" />
					
			<div><b>Add url:</b></div>
				<input id="url" type="text" name="urlIn" size="30" maxlength="50" />
			<br>
			<br>
			<div><b>Chose type of list:</b>
			...
			<br>
			<div><b>Add rank of source:</b></div>
	...
	$(document).ready(function() {validateAddNewFeed();});
