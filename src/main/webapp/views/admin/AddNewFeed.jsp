...
<body>
	...
	<form action="newFeed" id="addNewFeed" method="post" name="input_feed">
		<table>
			...
			<tr>
				<th>Add adaptor:</th>
				<th><input id="parser" type="text" size="30" maxlength="30" />
					<br></th>

			</tr>
			<tr>
				<th>Add source name:</th>
				<th><input id="sourceName" type="text" size="30" maxlength="50" />
					<br></th>
			</tr>
			<tr>
				<th>Add url:</th>
				<th><input id="url" type="text" size="30" maxlength="50" /> <br></th>
			</tr>
			<tr>
				<th>Add type of list:</th>
				<th><input id="listType" type="text" size="30" maxlength="50" />
					<br></th>
			</tr>
			<tr>
				<th>Add rank of source:</th>
				<th><input id="rank" type="text" size="30" maxlength="50" /> <br></th>
			</tr>
			<tr>
